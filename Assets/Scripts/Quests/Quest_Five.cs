...
public class Quest_Five : MonoBehaviour
{
    ...
    {
        if (_questSystem.questIndex == 7 && !stepOne) {
    ...
    {
        if (_questSystem.questIndex == 7 && stepTwo) {
    ...
    void Update()
    {
        if (_questSystem.questIndex == 7 && stepOne && !stepOneObject.activeSelf && !stepTwo && !stepTwoObject.activeSelf) {
